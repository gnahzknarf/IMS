...
REM ***************************************************************************/
    ...
    ***************************************************************************************************************************/
    ...
    BEGIN
        ...
        --
        IF apex_collection.collection_exists (p_collection_name => 'CUMULATIVE_VIEW') THEN
             apex_collection.delete_collection (p_collection_name => 'CUMULATIVE_VIEW');
        END IF;
        
        IF NOT APEX_COLLECTION.COLLECTION_EXISTS (p_collection_name => 'CUMULATIVE_VIEW') THEN
           APEX_COLLECTION.CREATE_COLLECTION_FROM_QUERY(p_collection_name => 'CUMULATIVE_VIEW',p_query => v_sql);
        END IF;            
    END populate_cumulative_collection;
