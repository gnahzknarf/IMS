...
REM 
*******************************************************************************************/
create or replace package body ims_util_crypto
as
  ...
  --
     ...
     * See `ims_util_crypto.hash_str` to handle wrapping
     *
     * @example
     * select
     *   rawtohex(
     *     ims_util_crypto.hash(
     *       p_src => sys.utl_raw.cast_to_raw('hello'),
     *       p_typ => 4 -- ims_util_crypto.gc_hash_sh256
     *     )
     *   ) example
     * from dual
     * ;
     ...
     * @created 4-Oct-2016
     * @param p_src
     * @param p_typ see `ims_util_crypto.gc_hash*` variables
     * @return
     */
    function hash(
      p_src raw,
     ...
     * @example
     * select
     *   ims_util_crypto.hash_str(
     *     p_src => 'hello',
     *     p_typ => 4 -- ims_util_crypto.gc_hash_md5
     *   ) example
     * from dual
     * ;
     *
     ...
     *       p_typ => 3, -- ims_util_crypto.gc_hmac_sh256
     ...
     * @created 4-Oct-2016
     * @param p_src
     * @param p_typ see `ims_util_crypto.gc_hmac*` variables
